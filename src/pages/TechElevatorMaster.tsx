...
const TechElevatorMaster = () => {
  ...
  const styles = {
   ...
   window.location.replace('https://docs.google.com/forms/d/18Z0MFh_uf8hBdownOd4yR2Xi-xVfDn0GS-RbHLdaK0U/viewform');
  };
  ...
  return (
    <div>
      ...
      <section className="bg-black flex pl-[20px] pt-[40px] lg:pt-[20px]">
...
export default TechElevatorMaster;
